...
struct Constants {
    double g, v_0, B2_m, y_d;
};

int func(double t, const double y[], double f[], void *params);

int main(int argc, char *argv[]) {
    struct Constants constants = {9.81, 700.0, 4.0e-5, 1.0e4};
    double v_0 = constants.v_0;
    gsl_odeiv2_system sys = {func, NULL, 4, &constants};
...
int func(double t, const double y[], double f[], void *params) {
    double g = ((struct Constants *) params)->g;
    double y_d = ((struct Constants *) params)->y_d;
    double B2_m = ((struct Constants *) params)->B2_m;
